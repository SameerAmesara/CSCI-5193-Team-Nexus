                ...
                <div className='min-h-screen md:px-20 px-3  pt-14 flex   text-black bg-gray-3002'>
                    <div className='  w-full  flex  pt-28 flex-col justify-start  items-center gap-4'>
                        ...
                        <div className='flex md:flex-row flex-col items-center justify-center md:gap-10 gap-1'>
                            <div className='md:text-8xl text-6xl titleT'>INSURAMART</div>
                            <div className=' flex justify-center items-center pt-1'>
                                <Link to="/" className=' text-white md:text-2xl text-lg blueCol  md:py-3 py-2 px-6 md:px-10 hover:bg-gray-600'>Browse Policies</Link>
                            </div>
                        </div>
                        <div>
                            <p className='md:text-xl text-sm'>Your <span className='text-yellow-500'>gateway</span> to best insurances.</p>
                        ...
                        <div className='pt-[8rem] md:px-[1rem] px-[0rem] w-full'>
                            <div className='titleT pb-6 text-2xl'>
                                <p className='titleT'>Featured Policies</p>
                            </div>
                            <div>
                                {
                                    loading ? 
